...
{
    /// <inheritdoc />
    public partial class FixArregloDeContructoresyIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreadoByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AsignadoUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FechacCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechacActualizacion = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketComments_AutorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CreadoByUserId",
                table: "Tickets",
